...
export default function EditTransportOrderMovementPage() {
  ...
  // Editable real fields from `transport_order_movement`
  ...
  const onSave = async () => {
    ...
    setSaving(true);
    try {
      Alert.alert("Not implemented", "Update will be wired in lib/actions/transport/serviceTypes/orderMovement.ts");
    } finally {
      setSaving(false);
    }
  };
    ...
    <>
      ...
      <ScrollView className="flex-1 bg-background">
        <View className="p-4 gap-4">
          <Card>
            <CardHeader>
              <CardTitle>Edit transport_order_movement</CardTitle>
            </CardHeader>
